...
public class RiderDetails_PremDriven {
	...
	static def fillRiderDetails() {
		...
		if (data['Step_Rider'] == 'Yes' || data['Step_Rider'] == 'yes') {
			...
			SS.capture("Plan_Details_Rider") // Defined capture method in methods package and passing screenshot name as argument
	...
	static def riderDetails(String policyTerm, String premiumTerm, String sumAssured) {
		...
		WebUI.setText(findTestObject('PlanDetails/Riders/RiderSA'), sumAssured)
	...
	static def CIWRiderDetails(String carepolicyTerm, String carepremiumTerm, String caresumAssured, String matpolicyTerm, String matpremiumTerm, String matsumAssured) {
		...
		WebUI.setText(findTestObject('PlanDetails/Riders/RiderSA'), caresumAssured)
		...
		WebUI.setText(findTestObject('PlanDetails/Riders/MaternitySA'), matsumAssured)
