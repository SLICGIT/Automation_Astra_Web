...
if(Executor.toString().equalsIgnoreCase("Yes")) {    // Execute cases where executor is mentioned as yes
	...
	try {
		...
		switch (true) {
			...
			case GlobalVariable.planName.toString().toLowerCase().startsWith('shriram life sunishchit laabh'):
				SunischitLaabh.fillPlanDetails(TC_ID)
				break
				
			case GlobalVariable.planName.toString().toLowerCase().startsWith('shriram life premier assured benefit'):
			...
			case GlobalVariable.planName.toString().toLowerCase().startsWith('shriram life flexi shield'):
				FlexiShield.fillPlanDetails(TC_ID)
				break
			...
			case GlobalVariable.planName.toString().toLowerCase().startsWith('shriram life pension plus'):
				PensionPlus.fillPlanDetails(TC_ID)
				break
