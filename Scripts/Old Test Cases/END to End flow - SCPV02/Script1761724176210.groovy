...
//		WebUI.waitForElementPresent(findTestObject('HomePage/ProposalType'), 20)
		...
		WebUI.enhancedClick(findTestObject('HomePage/ProposalType', [('Proposal_Type') : 'Non POS']))
...
//		WebUI.enhancedClick(findTestObject('HomePage/PolicyType'))
		...
		WebUI.enhancedClick(findTestObject('HomePage/KYCType', [('KYC_Type') : 'Regular']))
		...
		WebUI.setText(findTestObject('CustomerDetails/DOB'), ConvertAge.convertAgetoDOB(LA_Age))
		...
		WebUI.waitForElementClickable(findTestObject('CustomerDetails/MaritalStatus', [('LA_Marital_Status') : 'Single']), 20)
		
		WebUI.enhancedClick(findTestObject('CustomerDetails/MaritalStatus', [('LA_Marital_Status') : 'Single']))
		...
		WebUI.enhancedClick(findTestObject('CustomerDetails/PEP', [('LA_PEP') : 'No']))
		
		dropdowns.selectAntDropdown('LARisk_App', 'Medium')
		
//		if (Life_Type == 'Own Life') {
//		
//			WebUI.enhancedClick(findTestObject('CustomerDetails/Disability', [('LA_Disability') : 'No']))
//			
//		}
		...
		WebUI.enhancedClick(findTestObject('CustomerDetails/EIA', [('LA_EIA') : 'No']))
...
//			WebUI.enhancedClick(findTestObject('ProposerDetails/DisabilityNo'))
		...
		WebUI.enhancedClick(findTestObject('AddressDetails/CommAddressQues', [('Comm_Address') : 'Yes']))
...
//		WebUI.verifyMatch('Mobile Number Verified Successfully', 'Mobile Number Verified Successfully', false)
		...
		WebUI.enhancedClick(findTestObject('AddressDetails/whatsappQues', [('WhatsApp') : 'No']))
		...
		WebUI.callTestCase(findTestCase('Test Cases/Old Test Cases/Plan Details Page/SCPV02'),
			[
							('Life_Cover') : Life_Cover,
							('Death_Benefit') : Death_Benefit,
							('Death_Payout') : Death_Payout,
							('Death_Payout_Period') : Death_Payout_Period,
							('Death_Incr_Type') : Death_Incr_Type,
							('Death_Incr_Value') : Death_Incr_Value,
...
//		}
		...
		WebUI.enhancedClick(findTestObject('Medicals Details/GoodHealth', ['Qu_GoodHealth' : 'Yes']))
		
//		WebUI.enhancedClick(findTestObject('Medicals Details/SmokeQuestion', ['Qu_Smoke' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/AlcoholQuestion', ['Qu_Alcohol' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/DeformityQuestion', ['Qu_Deformity' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/DrugsQuestion', ['Qu_Drugs' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/LeaveQuestion', ['Qu_Leave' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/MedicalTreatmentQuestion', ['Qu_MedicalTreatment' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/AilmentsQuestion', ['Qu_Ailments' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/HIVQuestion', ['Qu_Disease' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/RespiratoryQuestion', ['Qu_Disorders' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/BPDiaQuestion', ['Qu_Diabetes' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/OtherIllQuestion', ['Qu_Other_Illness' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/EarEyesDisorderQuestion', ['Qu_EyeDisorder' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/HospitalIlQuestion', ['Qu_Hospitalize' : 'No']))
//		
//		WebUI.enhancedClick(findTestObject('Medicals Details/AnaemiaQuestion', ['Qu_Anaemia' : 'No']))
//		
//		if (Gender == 'Female') {
//		    WebUI.enhancedClick(findTestObject('Medicals Details/PregnencyQuestion', ['Qu_Pregnant' : 'No']))
//		
//		    WebUI.enhancedClick(findTestObject('Medicals Details/MisscarriageQuestion', ['Qu_Abortion' : 'No']))
//		
//		    WebUI.enhancedClick(findTestObject('Medicals Details/DeliveredBabyQuestion', ['Qu_Delivery' : 'No']))
//		
//		    WebUI.enhancedClick(findTestObject('Medicals Details/GynProblemQuestion', ['Qu_GynTreatment' : 'No']))
//		
...
//		}
		...
		WebUI.enhancedClick(findTestObject('OtherDetails/otherDetailsQuestion1', ['Qu_Hobbies' : 'No']))
		
		WebUI.enhancedClick(findTestObject('OtherDetails/otherDetailsQuestion2', ['Qu_Convicted' : 'No']))
...
//		WebUI.delay(1)
		...
		if (Life_Type == 'Own Life') {
			...
			WebUI.setText(findTestObject('NomineeDetails/DOB'), ConvertAge.convertAgetoDOB(Nominee_Age))
			...
			dropdowns.selectAntDropdown('reln', 'Father')
...
//			WebUI.setText(findTestObject('DocumentsUpload/PropAadhaar'), 'VI1234567')
		...
		if(Frequency != 'Single') {
			...
			WebUI.enhancedClick(findTestObject('NACHRegistration/SameBankBtn', ['Same_Bank' : 'Yes']))
		...
		WebUI.enhancedClick(findTestObject('PaymentDetails/PayOption', ['Payment_Option' : 'Single']))
		
		WebUI.enhancedClick(findTestObject('PaymentDetails/SubmitBTN'))
		
		Wait.addWait()
		
		WebUI.enhancedClick(findTestObject('PaymentDetails/PaymentType', ['Payment_Type' : 'Cheque/DD']))
		
		Wait.addWait()
		
		WebUI.enhancedClick(findTestObject('PaymentDetails/InstrumentType', ['Instrument_Type' : 'Cheque']))
