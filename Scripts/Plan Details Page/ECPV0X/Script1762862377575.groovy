...
selectAntDropdown('MaturityBenfit', Maturity_Benefit)

selectAntDropdown('Deathbenefit', Death_Benefit)

if (Life_Cover == 'Early Cash') {

	selectAntDropdown('SurvivalBen', SB_Benefit)
	
	selectAntDropdown('Surpaymode', SB_Payout)
...
WebUI.setText(findTestObject('null'), Sum_Assured)
