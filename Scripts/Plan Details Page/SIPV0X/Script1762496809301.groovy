...
// 1️⃣ Locate and click the dropdown based on label
// 3️⃣ Locate and click the option
// Select Life Cover Type
...
selectDropdownValue('Premium Frequency', Frequency)
...
selectDropdownValue('Premium Term', PPT)

WebUI.setText(findTestObject('PlanDetails/AnnualizePremium'), Annualized_Premium)
...
WebUI.enhancedClick(findTestObject('PlanDetails/SIPV0X/Calculate'))

addWait()

WebUI.scrollToElement(findTestObject('PlanDetails/SIPV0X/Next'), 1, FailureHandling.OPTIONAL)

WebUI.takeScreenshot(GlobalVariable.screenshotDir + '/3_PlanCalculate.jpg')

getPremiumValues()

WebUI.enhancedClick(findTestObject('PlanDetails/SIPV0X/Next'))
